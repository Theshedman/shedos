...
local parser = require("config.features.jpa.parser")
local generator = require("config.features.jpa.generator")
local repository = require("config.features.jpa.repository")
local dto = require("config.features.jpa.dto")
local migration = require("config.features.jpa.migration")
local documentation = require("config.features.jpa.documentation")
local controller = require("config.features.jpa.controller")
